...
export default function Footer() {
  return (
    <footer className="w-full px-4 sm:px-6 md:px-10 lg:px-16 xl:px-25 py-8 sm:py-10 md:py-16 lg:py-20 text-white bg-[#100B20] relative overflow-hidden">
      
      {/* Decorative elements - repositioned for different screen sizes */}
      ...
      <div className="flex flex-col lg:flex-row gap-8 md:gap-10 lg:gap-16 xl:gap-30">
        ...
        <div className="flex flex-col w-full lg:w-1/3 text-center lg:text-left">
          ...
          <div className="terms flex justify-center lg:justify-start gap-3 sm:gap-4 text-xs sm:text-sm mt-6 md:mt-8 lg:mt-auto" style={{fontFamily: "Montserrat"}}>
        ...
        {/* Right section - Links and Contact - stacked on mobile, side by side on tablet+ */}
        <div className='flex flex-col sm:flex-row gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-20 w-full lg:w-2/3'>
          
          {/* Useful Links */}
          <div className="flex flex-col gap-2 sm:gap-3 w-full sm:w-1/2 text-center sm:text-left">
            ...
            <div className='flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-3 mt-2'>
          ...
          <div className="flex flex-col gap-2 sm:gap-3 w-full sm:w-1/2 text-center sm:text-left">
            ...
            <div className='flex flex-col gap-3 sm:gap-4'>
              <p className='text-xs sm:text-sm md:text-sm flex items-center justify-center sm:justify-start gap-2' style={{fontFamily: "Montserrat"}}>
                <FiPhoneCall className="shrink-0"/>
                <span>+234 6707653444</span>
              </p>

              <div className='text-xs sm:text-sm md:text-sm flex items-start justify-center sm:justify-start gap-2 max-w-62.5 mx-auto sm:mx-0' style={{fontFamily: "Montserrat"}}>
      ...
      {/* Copyright */}
      <p className="text-center mt-8 sm:mt-10 md:mt-12 lg:mt-16 text-xs sm:text-sm text-white" style={{fontFamily: "Montserrat"}}>
