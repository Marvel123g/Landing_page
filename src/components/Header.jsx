...
export default function Header() {
  return (
    <header className='flex flex-col-reverse md:flex-row items-center w-full min-h-screen bg-linear-to-b from-[#150E28] to-[#1A0B2E] text-white px-4 md:px-8 py-10 md:py-0'>
